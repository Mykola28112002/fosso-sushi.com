...
export const MapPin = (props) => {
	return (
		...
		<path d="M12 13C13.6569 13 15 11.6569 15 10C15 8.34315 13.6569 7 12 7C10.3431 7 9 8.34315 9 10C9 11.6569 10.3431 13 12 13Z" stroke="white" strokeLinecap="round" strokeLinejoin="round"/>
		</svg>
	)
}
